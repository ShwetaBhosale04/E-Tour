...
const Itineraryview = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:8080/crud/itinerary/" + catmaster_id)
  ...
  useEffect(() => {
    fetch("http://localhost:8080/crud/costpage/" + catmaster_id)
            ...
            <div className="row justify-content-md-center">
              <div className="col col-lg-10 text-center">
                <NavLink className="nav-link " to={`/login`}>
                  <button type="button" class="w-20 btn btn-info btn-details">Book Now</button>
                </NavLink>
              </div>
            </div>
          </div>
