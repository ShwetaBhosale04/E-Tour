...
const Signup = () => {
    ...
    const onSubmit = (values, props) => {
        console.log(values)
        let obj = { fname: values.fname, lname: values.lname, email: values.email, phone: values.phone, password: values.password , flag: "Null" }
                            ...
                            <Fragment>
                                <Formik initialValues={forminisc} onSubmit={onSubmit} validationSchema={formValidation}>
                                    ...
                                    <Form method="POST" className="register-form" id="register-form">
                                        ...
                                        <button className='btn btn-info btn-details'>Register</button>
                                    </Form>
                                </Formik>
                            </Fragment>
                        </div>
